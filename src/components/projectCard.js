...
import { GrGatsbyjs, GrHtml5, GrReactjs } from "react-icons/gr"

const TooltipButton = React.forwardRef(({ children, ...rest }, ref) => (
...
export function ProjectCard(props) {
  ...
  return (
    <Box
      ...
      overflow="hidden"
    >
      <a href={props.excerpt ? props.excerpt : null} target="_blank">
        {hover && (
          <VStack>
            <Box
              position="absolute"
